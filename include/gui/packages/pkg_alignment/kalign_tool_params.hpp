#ifndef PKG_ALIGNMENT___KALIGN_TOOL_PARAMS__HPP
#define PKG_ALIGNMENT___KALIGN_TOOL_PARAMS__HPP

/*  $Id: kalign_tool_params.hpp 43794 2019-08-30 19:15:21Z katargir $
 * ===========================================================================
 *
...
/*!
 * CKalignToolParams class declaration
 */

class CKalignToolParams: public IRegSettings
{    
    friend class CKalignToolPanel;
public:
    CKalignToolParams();

    CKalignToolParams(const CKalignToolParams& data);
...
////@begin CKalignToolParams member function declarations
    wxString GetCommandLine() const { return m_CommandLine ; }
    void SetCommandLine(wxString value) { m_CommandLine = value ; }

    wxString GetKalignPath() const { return m_KalignPath ; }
    void SetKalignPath(wxString value) { m_KalignPath = value ; }

    bool GetQuietFlag() const { return m_QuietFlag ; }
    void SetQuietFlag(bool value) { m_QuietFlag = value ; }

////@end CKalignToolParams member function declarations

    wxString GetKalignExecutable() const;

////@begin CKalignToolParams member variables
private:
    wxString m_CommandLine;
    wxString m_KalignPath;
    bool m_QuietFlag;
////@end CKalignToolParams member variables
...
#endif // PKG_ALIGNMENT___KALIGN_TOOL_PARAMS__HPP
