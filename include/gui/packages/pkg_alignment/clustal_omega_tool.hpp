#ifndef PKG_ALIGNMENT___CLUSTAL_OMEGA_TOOL__HPP
#define PKG_ALIGNMENT___CLUSTAL_OMEGA_TOOL__HPP

/*  $Id: clustal_omega_tool.hpp 38460 2017-05-11 18:58:47Z evgeniev $
* ===========================================================================
*
...
*
* File Description:
*      Implementation of "Clustal Omega" tool for GenomeWorkbench.
*/
...
///////////////////////////////////////////////////////////////////////////////
/// CClustalOmegaTool
class  CClustalOmegaTool : public CAlgoToolManagerBase
{
public:
    CClustalOmegaTool();
...
protected:
    ...
    CClustalOmegaToolPanel*   m_Panel;
};
...
#endif // PKG_ALIGNMENT___CLUSTAL_OMEGA_TOOL__HPP
