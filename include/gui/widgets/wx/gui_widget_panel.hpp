#ifndef GUI_WIDGETS_WX___GUI_WIDGET_FRAME__HPP
#define GUI_WIDGETS_WX___GUI_WIDGET_FRAME__HPP

/*  $Id: gui_widget_panel.hpp 36855 2016-11-04 16:57:25Z filippov $
 * ===========================================================================
 *
...
class NCBI_GUIWIDGETS_WX_EXPORT CGuiWidgetPanel: public wxPanel, public IGuiWidget
{
    DECLARE_EVENT_TABLE()
public:
    /// Constructors
    CGuiWidgetPanel() : m_Closing(false), m_WidgetHost(), m_CmdProccessor() {}
