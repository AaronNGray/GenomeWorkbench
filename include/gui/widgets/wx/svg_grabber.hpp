#if !defined(GUI_WIDGETS_WX__SVG_GRABBER__HPP)
#define GUI_WIDGETS_WX__SVG_GRABBER__HPP
 ...
 * sequence graphic view for the purpose of saving it as a vector image.
 */
...
class NCBI_GUIWIDGETS_WX_EXPORT CSVGGrabber : public IImageGrabber
{ 
public:
...
#endif // GUI_WIDGETS_WX__G2PS_GRABBER__HPP
