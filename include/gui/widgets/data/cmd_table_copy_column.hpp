...
/*  $Id: cmd_table_copy_column.hpp 31553 2014-10-22 16:28:19Z katargir $
 * ===========================================================================
 *
...
class NCBI_GUIWIDGETS_DATA_EXPORT CCmdTableCopyColumn : 
...
public:
    ...
    CCmdTableCopyColumn(ITableData& tableData, int colFrom, int colTo, EOp op)
        : m_TableData(&tableData), m_ColFrom(colFrom), m_ColTo(colTo), m_Op(op) {}
