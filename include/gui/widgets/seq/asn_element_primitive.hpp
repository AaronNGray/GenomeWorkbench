#ifndef GUI_WIDGETS_SEQ___ASN_ELEMENT_PRIMITIVE__HPP
#define GUI_WIDGETS_SEQ___ASN_ELEMENT_PRIMITIVE__HPP

/*  $Id: asn_element_primitive.hpp 25759 2012-05-03 20:40:31Z katargir $
 * ===========================================================================
 *
...
class CAsnElementPrimitive : public CAsnElementItem
{
public:
...
class CAsnOctetStringBlock : public CAsnElementItem
{
public:
    CAsnOctetStringBlock(
                    ...
                    CAsnBioContext* bioContext) :
        CAsnElementItem(memberId, type, ptr, indent, bioContext),
            m_FirstBlock(firstBlock), m_DataOffset(dataOffset) {}
...
#endif  // GUI_WIDGETS_SEQ___ASN_ELEMENT_PRIMITIVE__HPP
