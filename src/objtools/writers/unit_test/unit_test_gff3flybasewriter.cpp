/*  $Id: unit_test_gff3flybasewriter.cpp 598218 2019-12-05 14:48:29Z grichenk $
* ===========================================================================
*
...
{
    return new CGff3FlybaseWriter(scope, ostr);
}
...
{   
    ...
    *pI >> *pAlign;
    ...
    cerr << "    Produced new flybase file " << output << "." << endl;
    cerr << " ... Done." << endl;
}
