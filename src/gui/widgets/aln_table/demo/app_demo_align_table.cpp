/*  $Id: app_demo_align_table.cpp 34647 2016-02-01 21:05:53Z katargir $
 * ===========================================================================
 *
...
///
class CDemoAlignTableApp : public CwxNCBIApp
{
protected:
...
DECLARE_APP(ncbi::CDemoAlignTableApp)
IMPLEMENT_APP_NO_MAIN(ncbi::CDemoAlignTableApp)
IMPLEMENT_WX_THEME_SUPPORT

bool CDemoAlignTableApp::x_CreateGUI()
{
    wxFrame* frame = new CwxDemoAlignTableFrame( NULL );
    frame->Show( true );
    return true;
}

void CDemoAlignTableApp::x_InitAppJobDispatcher()
{
