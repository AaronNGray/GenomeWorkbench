/*  $Id: work_dir.cpp 41446 2018-07-31 15:24:14Z katargir $
 * ===========================================================================
 *
...
void SetWorkDir(wxWindow* wnd, const wxString& workDir)
{
    ...
    for (wxWindowList::iterator child = children.begin(); child != children.end(); ++child) {
        IWorkDirClient* workDirClient = dynamic_cast<IWorkDirClient*>(*child);
        if (workDirClient)
            workDirClient->SetWorkDir(workDir);
        SetWorkDir(*child, workDir);
    }
}
