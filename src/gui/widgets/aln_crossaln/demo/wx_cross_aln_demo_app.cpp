/*  $Id: wx_cross_aln_demo_app.cpp 34649 2016-02-01 21:08:55Z katargir $
 * ===========================================================================
 *
...
class CCrossAlnDemoApp: public CwxNCBIApp
{
protected:
...
DECLARE_APP(ncbi::CCrossAlnDemoApp)
IMPLEMENT_APP_NO_MAIN(ncbi::CCrossAlnDemoApp)
IMPLEMENT_WX_THEME_SUPPORT


bool CCrossAlnDemoApp::x_CreateGUI()
{
    m_Dlg = new CCrossAlnDemoDlg(NULL);
    m_Dlg->Show();
    return true;
}
...
int NcbiSys_main(int argc, ncbi::TXChar* argv[])
{
    ...
    ncbi::CNCBIwxApplication ncbi_app("Cross Alignment Widget Demo");
