/*  $Id: component_track.cpp 34291 2015-12-08 23:38:49Z rudnev $
 * ===========================================================================
 *
...
CTrackTypeInfo CComponentTrack::m_TypeInfo("component_track",
    "Component track");

static string kDefTrackTitle = "Component Map";

CComponentTrack::CComponentTrack(CSGSegmentMapDS* ds, CRenderingContext* r_cntx)
    : CSegmentMapTrack(ds, r_cntx)
{}


CComponentTrack::~CComponentTrack()
{}


const CTrackTypeInfo& CComponentTrack::GetTypeInfo() const
{
    return m_TypeInfo;
}


string CComponentTrack::GetFullTitle() const
{
    if (GetTitle().empty()) {
...
CComponentTrackFactory::CreateTracks(SConstScopedObject& object,
                               ...
                               const TAnnotMetaDataList& /*src_annots*/) const
{
    ...
    segment_ds->SetSegmentLevel(CSGSegmentMapDS::eComponent);
    ...
    if (params.m_SkipGenuineCheck  ||  segment_ds->HasComponent(range)) {
        CRef<CComponentTrack> track(new CComponentTrack(segment_ds, r_cntx));
...
string CComponentTrackFactory::GetExtensionIdentifier() const
{
    return CComponentTrack::m_TypeInfo.GetId();
}


string CComponentTrackFactory::GetExtensionLabel() const
{
    return CComponentTrack::m_TypeInfo.GetDescr();
}


CRef<CTrackConfigSet>
CComponentTrackFactory::GetSettings(const string& /*profile*/,
