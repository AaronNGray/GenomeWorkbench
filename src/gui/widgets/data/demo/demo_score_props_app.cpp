/*  $Id: demo_score_props_app.cpp 34660 2016-02-01 21:26:11Z katargir $
 * ===========================================================================
 *
...
class CDemoAlignScorePropsApp: public CwxNCBIApp
{
protected:
...
DECLARE_APP(ncbi::CDemoAlignScorePropsApp)
IMPLEMENT_APP_NO_MAIN(ncbi::CDemoAlignScorePropsApp)
IMPLEMENT_WX_THEME_SUPPORT

bool CDemoAlignScorePropsApp::x_CreateGUI()
{
    CScoreMethodsDlg(NULL).ShowModal();
    return false;
}
