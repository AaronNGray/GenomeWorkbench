/*  $Id: gui_object_info_distancematrix.cpp 41372 2018-07-18 20:45:38Z rudnev $
 * ===========================================================================
 *
...
class CGuiObjectInfoDistanceMatrix : public CObject, public IGuiObjectInfo
{
public:
    static CGuiObjectInfoDistanceMatrix* CreateObject(SConstScopedObject& object, ICreateParams* params);

    virtual string GetType() const { return "Distance Matrix"; }
...
void initCGuiObjectInfoDistanceMatrix()
{
    CInterfaceRegistry::RegisterFactory(
            typeid(IGuiObjectInfo).name(),
            CDistanceMatrix::GetTypeInfo(),
            new CObjectInterfaceFactory<CGuiObjectInfoDistanceMatrix>());
}

CGuiObjectInfoDistanceMatrix* CGuiObjectInfoDistanceMatrix::CreateObject(
    SConstScopedObject& object, ICreateParams* /*params*/)
{
    CGuiObjectInfoDistanceMatrix* gui_info = new CGuiObjectInfoDistanceMatrix();
    gui_info->m_Object = object.object;
    gui_info->m_Scope  = object.scope;
    return gui_info;
}

string CGuiObjectInfoDistanceMatrix::GetLabel() const
{
    string label;
...
void CGuiObjectInfoDistanceMatrix::GetToolTip(ITooltipFormatter& tooltip, string& /*t_title*/, TSeqPos /*at_p*/, bool* isGeneratedBySvc) const
{
    string t_text;
