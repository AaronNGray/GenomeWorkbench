/*  $Id: gui_object_info_default.cpp 41372 2018-07-18 20:45:38Z rudnev $
 * ===========================================================================
 *
...
class CGuiObjectInfoDefault : public CObject, public IGuiObjectInfo
{
public:
    static CGuiObjectInfoDefault* CreateObject(SConstScopedObject& object, ICreateParams* params);
...
void initCGuiObjectInfoDefault()
{
    CInterfaceRegistry::RegisterFactory(
            typeid(IGuiObjectInfo).name(),
            new CObjectInterfaceFactory<CGuiObjectInfoDefault>());
}

CGuiObjectInfoDefault* CGuiObjectInfoDefault::CreateObject(
    SConstScopedObject& object, ICreateParams* /*params*/)
{
    CGuiObjectInfoDefault* gui_info = new CGuiObjectInfoDefault();
    gui_info->m_Object = object.object;
    gui_info->m_Scope  = object.scope;
    return gui_info;
}

string CGuiObjectInfoDefault::GetLabel() const
{
    string label;
...
void CGuiObjectInfoDefault::GetToolTip(ITooltipFormatter& tooltip, string& /*t_title*/, TSeqPos /*at_p*/, bool* isGeneratedBySvc) const
{
    string t_text;
