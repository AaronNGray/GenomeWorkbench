#ifndef PKG_SEQUENCE___GFF_LOAD_MANAGER__HPP
#define PKG_SEQUENCE___GFF_LOAD_MANAGER__HPP

/*  $Id: gff_load_manager.hpp 38477 2017-05-15 21:10:59Z evgeniev $
* ===========================================================================
*
...
public:
	...
	static string Id() { return "file_loader_gff"; }
	static string Label() { return "GFF"; }
...
protected:
    ...
    {
    public:
        CPage(CGffLoadManager& manager) : m_Manager(manager) {}
        virtual wxPanel* GetPanel();
        virtual bool CanLeavePage(bool) { return true; }
        CGffLoadManager& m_Manager;
    };

    CGffParamsPanel* x_GetParamsPanel();

    IServiceLocator* m_SrvLocator;
    wxWindow*        m_ParentWindow;
    EState           m_State;
    string           m_RegPath;
    CGffParamsPanel* m_ParamsPanel;
...
#endif // PKG_SEQUENCE___GFF_LOAD_MANAGER__HPP
