#ifndef PKG_SEQUENCE___VCF_LOAD_MANAGER__HPP
#define PKG_SEQUENCE___VCF_LOAD_MANAGER__HPP

/*  $Id: vcf_load_manager.hpp 38477 2017-05-15 21:10:59Z evgeniev $
* ===========================================================================
*
...
public:
	...
	static string Id() { return "file_loader_vcf"; }
	static string Label() { return "Variant Call Format"; }
...
protected:
    ...
    {
    public:
        CPage(CVCFLoaderManager& manager) : m_Manager(manager) {}
...
#endif // PKG_SEQUENCE___VCF_LOAD_MANAGER__HPP
