#ifndef PKG_SEQUENCE___FASTA_FORMAT_LOAD_MANAGER__HPP
#define PKG_SEQUENCE___FASTA_FORMAT_LOAD_MANAGER__HPP

/*  $Id: fasta_format_load_manager.hpp 38477 2017-05-15 21:10:59Z evgeniev $
 * ===========================================================================
 *
...
public:
	...
	static string Id() { return "file_loader_fasta"; }
	static string Label() { return "FASTA"; }
...
protected:
    ...
    {
    public:
        CPage(CFASTAFormatLoadManager& manager) : m_Manager(manager) {}
...
#endif  // PKG_SEQUENCE___FASTA_FORMAT_LOAD_MANAGER__HPP
