#ifndef PKG_SEQUENCE___AGP_LOAD_MANAGER__HPP
#define PKG_SEQUENCE___AGP_LOAD_MANAGER__HPP

/*  $Id: agp_loader.hpp 38477 2017-05-15 21:10:59Z evgeniev $
* ===========================================================================
*
...
public:
	...
	static string Id() { return "file_loader_agp"; }
	static string Label() { return "AGP"; }
...
protected:
    ...
    {
    public:
        CPage(CAgpLoader& manager) : m_Manager(manager) {}
...
#endif // PKG_SEQUENCE___AGP_LOAD_MANAGER__HPP
