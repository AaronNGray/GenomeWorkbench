#ifndef PKG_SEQUENCE___BEG_LOAD_MANAGER__HPP
#define PKG_SEQUENCE___BEG_LOAD_MANAGER__HPP

/*  $Id: bed_load_manager.hpp 38477 2017-05-15 21:10:59Z evgeniev $
* ===========================================================================
*
...
public:
	...
	static string Id() { return "file_loader_bed"; }
	static string Label() { return "BED"; }
...
protected:
    ...
    {
    public:
        CPage(CBedLoadManager& manager) : m_Manager(manager) {}
...
#endif // PKG_SEQUENCE___BEG_LOAD_MANAGER__HPP
