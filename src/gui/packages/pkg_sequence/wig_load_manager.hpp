#ifndef PKG_SEQUENCE___WIG_LOAD_MANAGER__HPP
#define PKG_SEQUENCE___WIG_LOAD_MANAGER__HPP

/*  $Id: wig_load_manager.hpp 38477 2017-05-15 21:10:59Z evgeniev $
* ===========================================================================
*
...
public:
	...
	static string Id() { return "file_loader_wig"; }
	static string Label() { return "WIG"; }
...
protected:
    ...
    {
    public:
        CPage(CWigLoadManager& manager) : m_Manager(manager) {}
...
#endif // PKG_SEQUENCE___WIG_LOAD_MANAGER__HPP
