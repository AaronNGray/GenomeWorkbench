#ifndef PKG_ALIGNMENT___PHY_LOAD_MANAGER__HPP
#define PKG_ALIGNMENT___PHY_LOAD_MANAGER__HPP

/*  $Id: phy_loader.hpp 38477 2017-05-15 21:10:59Z evgeniev $
* ===========================================================================
*
...
public:
	...
	static string Id() { return "file_loader_phy"; }
	static string Label() { return "Newick/Nexus Tree"; }

protected:
    /* We do not have any for now, actually.
    enum EState {
        eInvalid = -1,
        eParams,
        eCompleted
...
protected:
    ...
    // EState  m_State; // We do not have any for now, actually.
...
#endif // PKG_ALIGNMENT___PHY_LOAD_MANAGER__HPP
