@ECHO OFF
REM $Id: build.msvc8.bat 19467 2009-06-24 13:36:57Z dicuccio $
REM ===========================================================================
REM 
...
set SOL=%1\compilers\msvc800_prj\dll\build\gbench\ncbi_gbench.sln
set project=%2
set mode=%3
set log=%4
...
%DEVENV% %SOL% /build "%3|%arch%" /project "%project%" /out %log%
